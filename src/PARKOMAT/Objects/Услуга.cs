...
namespace IIS.PARKOMAT
{
    ...
    [AssociatedDetailViewAttribute("УслугаE", "Автомобиль", "АвтомобильE", true, "", "Автомобиль", true, new string[] {
            ""})]
    ...
    public class Услуга : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.PARKOMAT.Услуги fНаименование;
        
        private string fДлительность;
        
        private IIS.PARKOMAT.DetailArrayOfАвтомобиль fАвтомобиль;
        ...
        public virtual IIS.PARKOMAT.Услуги Наименование
        {
            get
            {
                ...
                IIS.PARKOMAT.Услуги result = this.fНаименование;
        ...
        /// Услуга.
        /// </summary>
        // *** Start programmer edit section *** (Услуга.Автомобиль CustomAttributes)

        // *** End programmer edit section *** (Услуга.Автомобиль CustomAttributes)
        public virtual IIS.PARKOMAT.DetailArrayOfАвтомобиль Автомобиль
        {
            get
            {
                // *** Start programmer edit section *** (Услуга.Автомобиль Get start)

                // *** End programmer edit section *** (Услуга.Автомобиль Get start)
                if ((this.fАвтомобиль == null))
                {
                    this.fАвтомобиль = new IIS.PARKOMAT.DetailArrayOfАвтомобиль(this);
                }
                IIS.PARKOMAT.DetailArrayOfАвтомобиль result = this.fАвтомобиль;
                // *** Start programmer edit section *** (Услуга.Автомобиль Get end)

                // *** End programmer edit section *** (Услуга.Автомобиль Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Услуга.Автомобиль Set start)

                // *** End programmer edit section *** (Услуга.Автомобиль Set start)
                this.fАвтомобиль = value;
                // *** Start programmer edit section *** (Услуга.Автомобиль Set end)

                // *** End programmer edit section *** (Услуга.Автомобиль Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УслугаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаE", typeof(IIS.PARKOMAT.Услуга));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаL", typeof(IIS.PARKOMAT.Услуга));
                }
            }
        }
    }
