...
namespace IIS.PARKOMAT
{
    ...
    public class ПаркМесто : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.PARKOMAT.Статусы fСтатус;
        ...
        public virtual IIS.PARKOMAT.Статусы Статус
        {
            get
            {
                ...
                IIS.PARKOMAT.Статусы result = this.fСтатус;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПаркМестоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПаркМестоE", typeof(IIS.PARKOMAT.ПаркМесто));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПаркМестоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПаркМестоL", typeof(IIS.PARKOMAT.ПаркМесто));
                }
            }
        }
    }
